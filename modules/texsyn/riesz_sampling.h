...
public:
	...
	static Ref<Image> stochastic_mean(const Ref<Image> &image, const Ref<Image> &pc, int n_subdivision, const Ref<Image> &classes, const Array &sampler_realization, int realization_size);
